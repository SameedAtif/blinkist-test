...
var _analyticsApiJs = require("./analytics-api.js");
// Issues with importing jQuery :(
exports.default = window.$ = window.jQuery = (0, _jqueryDefault.default);
// Your code here
/**
 ...
 */ const storeUniqueVisit = (assignedVariation)=>{
    const pageView = {
        pageViewId: `${(0, _constantsJs.VIEW_ID_NAME)}_${(0, _uuid.v4)()}`,
...
const handleClickEvent = (assignedVariation)=>{
    const clickEvent = {
        clickEventId: `${(0, _constantsJs.EVENT_ID_NAME)}_${(0, _uuid.v4)()}`,
        timestamp: new Date().toISOString(),
        visitorId: assignedVariation[0],
        assignedVariation: assignedVariation[1]
    };
...
},{"./styles.css":"lW6qc","jquery":"hgMhh","uuid":"j4KJi","./helpers.js":"ecN5O","./constants.js":"3huJa","./analytics-api.js":"gDoxF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lW6qc":[function() {},{}],"hgMhh":[function(require,module,exports) {
/*!
...
const getCookie = ()=>{
    ...
    for(let i = 0; i < cookies.length; i++){
        ...
        if (cookie.startsWith((0, _constants.VISITOR_COOKIE_NAME))) return cookie;
    }
    return null;
};
const createOrReadCookie = ()=>{
    ...
    if (!variation) {
        const visitId = `${(0, _constants.VISITOR_COOKIE_NAME)}_${(0, _uuid.v4)()}`;
        const assignedVariation = getRandomVariation();
        (0, _jsCookieDefault.default).set(visitId, assignedVariation); // Expires in 1 day
        return [
            visitId,
            assignedVariation
        ];
...
},{"./constants":"3huJa","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","uuid":"j4KJi","js-cookie":"c8bBu"}],"3huJa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"gDoxF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
